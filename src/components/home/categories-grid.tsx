...
export function CategoriesGrid() {
    const categories = [
        {
            title: "Industrial Dustbins",
            desc: "Heavy-duty waste management solutions.",
            href: "/products?category=dustbins",
            color: "border-l-[#d4af37]" // Gold
        },
        {
            title: "Storage Crates",
            desc: "Stackable, nestable, and foldable crates.",
            href: "/products?category=crates",
            color: "border-l-[#5D4037]" // Brown
        },
        {
            title: "Pallets & Bins",
            desc: "Racking pallets and FPO bins.",
            href: "/products?category=pallets",
            color: "border-l-black" // Black
        },
    ];
            ...
            <div className="container-custom">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {categories.map((cat, i) => (
                        <Link href={cat.href} key={i} className="group">
                            <div className={`
                                ...
                                p-8 flex flex-col justify-between overflow-hidden border-l-8 ${cat.color}
                            `}>
